    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-end justify-center">
        ...
        <div className="relative w-full max-w-lg bg-white rounded-t-2xl max-h-[90vh] flex flex-col">
          ...
          {product.image_url && (
            <div
              className="relative w-full h-48 rounded-t-2xl overflow-hidden flex-shrink-0 cursor-pointer"
          ...
          <div className="flex-1 overflow-y-auto px-4 pb-2">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                rows={3}
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 bg-white resize-none focus:outline-none focus:ring-2"
